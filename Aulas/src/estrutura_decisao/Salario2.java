 ...
 * @author Aluno
 */
public class Salario2 extends javax.swing.JFrame {
    ...
    private void jButtonCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCalcActionPerformed
        ...
        if(valorAumento>= 150 && valorAumento <=300){
            msg = "Aumento razoavel de salario";
        }else if(valorAumento>= 301 && valorAumento <=450){
            msg="Bom aumento de salario";
        }else if(valorAumento>450){
            msg = "Excelente aumento de salario";
        }
        
        jTextResultado.setText(String.format("Nome: %s\nSalario antigo: R$%.2f\nPorcentagem de aumento:%s%% \nValor aumento: R$%.2f\nNovo salario: R$%.2f\n%s", nome,salarioOld,PERCENT_AUMENTO,valorAumento,salarioNew,msg));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Salario2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
