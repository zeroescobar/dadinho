 ...
 * @author Aluno
 */
public class Viagem2 extends javax.swing.JFrame {
    ...
    private void jButtonCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCalcActionPerformed
        ...
        String theMaisBarato = "";
        
        if(custoGas < custoEta){
            theMaisBarato="Gasolina";
        }else{
            theMaisBarato = "etanol";
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Viagem2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
