...
public class ViagemV3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonCalcular.setBounds(108, 341, 326, 44);
    ...
    private void jButtonCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCalcularActionPerformed
        ...
        Viagem viagem = new Viagem(veiculo, distancia, mediaKmGasolina, mediaKmEtanol);
        
        // Processamento
        float valorTotalGasolina = viagem.custoComGasolina();
        float valorTotalEtanol = viagem.custoComEtanol();
        
        String mensagemCombustivel = viagem.verificarCombustivelMaisBarato(valorTotalGasolina, valorTotalEtanol);
